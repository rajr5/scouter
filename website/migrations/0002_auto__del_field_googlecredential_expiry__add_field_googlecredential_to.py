...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GoogleCredential.expiry'
        db.delete_column('website_googlecredential', 'expiry')

        # Adding field 'GoogleCredential.token_expiry'
        db.add_column('website_googlecredential', 'token_expiry',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'GoogleCredential.expiry'
        raise RuntimeError("Cannot reverse this migration. 'GoogleCredential.expiry' and its values cannot be restored.")
        # Deleting field 'GoogleCredential.token_expiry'
        db.delete_column('website_googlecredential', 'token_expiry')
    ...
    models = {
        ...
        'website.googlecredential': {
            ...
            'token_expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 5, 0, 0)'}),
