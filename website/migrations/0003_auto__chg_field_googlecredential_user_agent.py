...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GoogleCredential.user_agent'
        db.alter_column('website_googlecredential', 'user_agent', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'GoogleCredential.user_agent'
        raise RuntimeError("Cannot reverse this migration. 'GoogleCredential.user_agent' and its values cannot be restored.")
