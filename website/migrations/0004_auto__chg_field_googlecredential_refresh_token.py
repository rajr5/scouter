...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GoogleCredential.refresh_token'
        db.alter_column('website_googlecredential', 'refresh_token', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'GoogleCredential.refresh_token'
        raise RuntimeError("Cannot reverse this migration. 'GoogleCredential.refresh_token' and its values cannot be restored.")
