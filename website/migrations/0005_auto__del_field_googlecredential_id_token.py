...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GoogleCredential.id_token'
        db.delete_column('website_googlecredential', 'id_token')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'GoogleCredential.id_token'
        raise RuntimeError("Cannot reverse this migration. 'GoogleCredential.id_token' and its values cannot be restored.")
