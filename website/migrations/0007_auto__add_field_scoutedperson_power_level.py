...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScoutedPerson.power_level'
        db.add_column('website_scoutedperson', 'power_level',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScoutedPerson.power_level'
        db.delete_column('website_scoutedperson', 'power_level')
    ...
    models = {
        ...
        'website.googlecredential': {
            ...
            'token_expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 3, 0, 0)'}),
