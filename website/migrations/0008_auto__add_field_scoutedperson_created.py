...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScoutedPerson.created'
        db.add_column('website_scoutedperson', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 9, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScoutedPerson.created'
        db.delete_column('website_scoutedperson', 'created')
    ...
    models = {
        ...
        'website.googlecredential': {
            ...
            'token_expiry': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 4, 0, 0)'}),
